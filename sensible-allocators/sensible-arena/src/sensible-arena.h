...
#  define senarena_always_inline __attribute__((__always_inline__))
# endif
#endif
...
void *senarena_alloc(struct senarena *restrict arena, size_t byte_amount, size_t alignment) senarena_malloc;
#endif
...
extern senarena_always_inline inline
senarena_malloc
#endif
